      ...
      <ul class="collapsible">
        ...
        <li>
          <div class="collapsible-header blue darken-2 white-text">
            ...
            <p><span class="black-text">Name:</span> <?php echo strtoupper($_SESSION['s_name']); ?></p>
            <p><span class="black-text">Phone:</span> <?php echo $_SESSION['s_phone']; ?></p>
            <p><span class="black-text">Email:</span> <?php echo $_SESSION['s_email']; ?></p>
